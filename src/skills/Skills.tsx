...
export const Skills = () => {
    ...
    const reduxDescription = 'bla blala vlalafldvc; wsdasdgaas sdgvmasda dsvvamda!'


    return (
        <div className={style.skillsBlock}>
            <div className={style.skillsContainer}>
                <Title title={'ABOUT '} spanTitle={'ME'} subtitle={'I CODER, AND I LOVE WHAT I DO.'}/>
                <div className={style.skills}>
                    ...
                    <Skill title={'Redux'} description={reduxDescription}
